...
echo Valid options: "SXAR_U" "SXAR_E"
...
if "%Input1%" equ "" goto :Exit
if "%Input1%" equ "SXAR_U" goto :USA
if "%Input1%" equ "SXAR_E" goto :PAL
...
:USA
set ROMVer=(USA)
set ROMNAME=Spider-Man and the X-Men in Arcade's Revenge
goto :Assemble
...
%asarVer% --no-title-check --define GameID="%GAMDID%" --define ROMID="%Input1%" --define FileType=4 --define PathToFile="SPC700/SPC700_Engine_SXAR.asm" ..\Global\AssembleFile.asm SPC700\SPC700_Engine_SXAR.bin
...
echo Cleaning up...
if exist ..\%GAMDID%\SPC700\SPC700_Engine_SXAR.bin del ..\%GAMDID%\SPC700\SPC700_Engine_SXAR.bin
