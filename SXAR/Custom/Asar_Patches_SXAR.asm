; Note: Put your custom routine/data macros, references to them, and defines in this file from within the SXAR_InsertIntegratedPatches and SXAR_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro SXAR_InsertIntegratedPatches()
...
macro SXAR_ApplyPatchesPostAssembly()
